...
#########################################
FROM alpine/terragrunt:1.15.6@sha256:bc18394563e9d064f7fd62c1ef02ccbe5fcbdd384dd118052a17e635e58f0f75 AS terragrunt
...
FROM alpine/helm:4.2.1@sha256:13b651dfaa030b96e2916b51183449475626275fa302a46763d1e914fb2ddf90 AS helm
FROM golang:1.26.4-alpine@sha256:f48dee30f194256463e61bf127acb2d50e9f46968c4fdb1243e67d96d9aba164 AS golang
...
FROM goreleaser/goreleaser:v2.16.0@sha256:0648ddfa35769070197ba1cdf22a16dc452caf9315e66b91791308a543baf229 AS goreleaser
...
FROM mstruebing/editorconfig-checker:v3.7.0@sha256:1c2a46e4156331e2953862ad7c6c7df9e07bb87157beb650de182bdb5450d0b3 AS editorconfig-checker
...
FROM ghcr.io/clj-kondo/clj-kondo:2026.05.25-alpine@sha256:96cb221f9dc3ce944589995fddf2274145a6c4afd468f110de080f19bcce0f56 AS clj-kondo
...
FROM ghcr.io/aquasecurity/trivy:0.71.1@sha256:5103f6f5e89061728aad4ad5a250627dd0fc9b2a92eb876f3762677a4222f9e0 AS trivy
FROM ghcr.io/yannh/kubeconform:v0.8.0@sha256:b5d1b07e61c375597a6e2086bc110257348bba9f9f9a3b30e6e67f3ba0b1aa06 AS kubeconform
